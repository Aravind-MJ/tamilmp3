...
<script src="view_movie_director.js" type="text/javascript"></script>
            ...
            <div class="box-body">
                ...
                <table id="song_table" class="table table-bordered table-striped">
                    ...
                    <tr ng-repeat="director in directors">
                        ...
                        <td>{{ director.name}}</td>
                        <td>
                            <a class="btn btn-warning" href="edit_movie_director.php?id={{ director.id}}">EDIT</a>
                        </td>
                        <td>
                            <a class="btn btn-danger" href="delete_movie_director.php?id={{ director.id}}">DELETE</a>
                        </td>
                    </tr>
                </table>
                <center>
